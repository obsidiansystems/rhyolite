...
## 2019-08-29 - Unreleased
* Add `Rhyolite.Backend.Which`
  * `which` for looking up the full path of an executable
  * `staticWhich` which additionally asserts that an executable is contained in the nix store at compile-time
